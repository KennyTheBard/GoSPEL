...
/**
 *  Handle the arguments and call the Copy function from the lib.
 *  Usage: copy <image>
 */
func CopyHandle(scope generics.Namespace, raw_args []generics.Void) (generics.Void, error.Error) {
    ...
    // call the operation
    return lib.Copy(img), error.CreateNoError()
}
